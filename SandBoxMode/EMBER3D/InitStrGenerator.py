...
class InitStr_Network(nn.Module):
    def __init__(self, 
        ...
        self.embed_x = nn.Sequential(nn.Linear(node_dim_in+20, node_dim_hidden), nn.ELU(inplace=True))
        ...
        # outputs
        self.get_xyz = nn.Linear(node_dim_hidden, 12)
